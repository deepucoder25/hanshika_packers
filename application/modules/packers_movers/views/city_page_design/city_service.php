...
<div class="row g-4 mt-5 mb-4">
    ...
    <div class="col-md-6 col-lg-3 d-flex">
        <div class="pm-city-srv-card w-100 d-flex flex-column">
            ...
            <div class="pm-city-srv-desc flex-grow-1"><?= $city ?> <?= $company3 ?> Professional car relocation service offering secure transport of vehicles, either through dedicated car carriers or enclosed trailers, ensuring your car is safely delivered from <?= $city ?> to the new location.</div>
